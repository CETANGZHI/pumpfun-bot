...
exports.generateTokenNameAndSymbol = generateTokenNameAndSymbol;
exports.generateTokenDescription = generateTokenDescription;
exports.uploadImageAndGetUri = uploadImageAndGetUri;
exports.generateAndUploadMetadata = generateAndUploadMetadata;
const uuid_1 = require("uuid");
// Function to generate a random token name and symbol
function generateTokenNameAndSymbol() {
...
function generateTokenDescription(name, symbol) {
    const descriptions = [
...
async function uploadImageAndGetUri(name, symbol) {
    const imagePath = `/home/ubuntu/pumpfun-bot/images/${symbol}_${(0, uuid_1.v4)()}.png`;
...
async function generateAndUploadMetadata(name, symbol, description, imageUrl) {
    const metadata = {
        name: name,
        symbol: symbol,
