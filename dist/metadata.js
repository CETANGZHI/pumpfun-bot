...
export function generateTokenNameAndSymbol() {
...
export function generateTokenDescription(name, symbol) {
    const descriptions = [
...
export async function uploadImageAndGetUri(name, symbol) {
...
export async function generateAndUploadMetadata(name, symbol, description, imageUrl) {
    const metadata = {
        name: name,
        symbol: symbol,
